...
/** See KDoc for [GraphDslSchema] for background. */
interface GraphDslSchema {
    ...
    interface Directive : HasArgs {
        ...
        override val appliedDirectives: Collection<AppliedDirective>
    ...
    interface Extension<out D : TypeDef, out M : Def> {
        ...
        companion object {
            fun <D : TypeDef, M : Def> of(
                ...
                isBase: Boolean,
                appliedDirectives: Collection<AppliedDirective>,
    ...
    interface EnumValue : Def {
        ...
        val containingExtension: Extension<Enum, EnumValue>
    ...
    companion object {
        // Used to indicate that a field or type should be ignored by GraphDslSchema
        // but allowed to be used in other intermediate representations like GJSchema, GJSchemaRaw,
        // compilation schema sdl files, etc.
        const val GRAPHDSL_IGNORE_SYMBOL = "GRAPHDSL_IGNORE"
